...
(function() {
	...
	task("lintNode", function() {
		...
		jshint.checkFiles({
			files: [ "src/*.js", "src/server/**/*.js", "tests/smoke/*.js", "tests/server/*.js", "tests/util/*.js", "build/**/*.js" ],
	...
	task("lintClient", function() {
		...
		jshint.checkFiles({
			files: [ "src/client/**/*.js", "tests/client/**/*.js" ],
	...
	task("testSmoke", [ "build" ], function() {
		...
		mocha.runTests({
			files: [ "tests/smoke/smoke_test.js" ],
			options: MOCHA_CONFIG
		}, complete, fail);
	}, { async: true });
